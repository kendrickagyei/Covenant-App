...
import { importData, resetData, getDataInfo, parseCSV, parseJSON, hasImportedData } from '../store/dataStore.js'
...
const Settings = ({ theme, onThemeChange }) => {
  ...
  // Refresh data info when component mounts (e.g. after navigating back)
  useEffect(() => {
    refreshDataInfo()
  }, [refreshDataInfo])
